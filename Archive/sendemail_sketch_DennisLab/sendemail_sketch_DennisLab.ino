...
// change to your email address (sender)
  client.println(F("MAIL From: hrandemail@gmail.com"));
 
  if(!eRcv()) return 0;
 
// change to recipient address
  Serial.println(F("Sending To"));
  client.println(F("RCPT To: hrandemail@gmail.com"));
...
// change to recipient address
  client.println(F("To: You hrandemail@gmail.com"));
 
// change to your address
  client.println(F("From: Me hrandemail@gmail.com"));
